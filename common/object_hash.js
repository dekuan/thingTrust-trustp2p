...
let getSourceString	= require( './string_utils' ).getSourceString;
...
{
	let objNakedUnit	= _.cloneDeep( objUnit );
...
{
	let objNakedDeviceMessage	= _.clone( objDeviceMessage );
